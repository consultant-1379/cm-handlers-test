package com.ericsson.nms.mediation.HandlerTestClient.rest.config;
...
public class TestEventHandlerContext implements EventHandlerContext {
    
    private final Configuration config;
    
    public TestEventHandlerContext(final Configuration config) {
        this.config = config;
    }
    ...
    @Override
    public void sendControlEvent(final ControlEvent arg0) {
